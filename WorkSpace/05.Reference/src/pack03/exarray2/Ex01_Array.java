...
public class Ex01_Array {
	public static void main(String[] args) {
		//1차원 배열 : 변수(객체)를 요소로 가지는 배열 <- 하나의 정보만 담아짐    //  String a = "A";  이게아니라
		//ex)String이라는 타입을 하나로 묶어서 여러개의 정보를 담을수있는 자료구조. String[] sArr;  이런식으로
		//단축(x축 또는 y축으로 한가지 방향만 가지는 구조) [0][1][2][3]
		
		//2차원 배열 : 같은 타입의 1차원 배열을 요소로 가지는 형태
		//x와y축이 동시에 있는 행열 (행과열의 갯수가 일정할때 == 정방형 ==행x열 => 배열의 총 데이터 개수)
		//[
		...
		// 배열의 차원수 == for문개수와 같다. (배열의 모든 내용 출력하려면)   ex) 3차원배열은 for문 3개있음 되겠다..
		arr[1][0] = 5;
		arr[1][1] = 6;
		arr[1][2] = 7;
		arr[1][3] = 8;
