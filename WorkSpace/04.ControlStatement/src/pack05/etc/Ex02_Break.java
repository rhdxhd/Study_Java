...
public class Ex02_Break {
		public static void main(String[] args) {
			...
			String inputData = sc.nextLine(); //사용자가 콘솔창에 입력을 하다가 enter을 치면 
											   // 입력 된 데이터 전부를 가져옴.
			//형변환 연습이 안된다. (x)
			//int inputInt = sc.nextInt(); <-사용 금지
			//blockState: 입력을 대기한다.(프로그램은 위에서 아래로 흐름).
						//콘솔창에 아무것도 안나타 나다가 내가 엔터를 치면 나타남. 엔터칠때까지 출력 기다림.
			System.out.println("사용자가 입력 : "+inputData);
			//sc.nextLine()은 사용자가 입력한 값을 '반드시' String형태로 우리한테 되돌려줌.
